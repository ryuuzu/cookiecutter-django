...
AWS_ACCESS_URL = env("DJANGO_AWS_ACCESS_URL", default=None)

AWS_S3_URL_PROTOCOL = env("DJANGO_AWS_S3_URL_PROTOCOL", default="https")
AWS_S3_USE_SSL = env.bool("DJANGO_AWS_S3_USE_SSL", False)
AWS_S3_VERIFY = env.bool("DJANGO_AWS_S3_VERIFY", False)
AWS_S3_ADDRESSING_STYLE = env("DJANGO_AWS_S3_ADDRESSING_STYLE", default="path")
...
MEDIA_URL = f"{AWS_S3_URL_PROTOCOL}://{AWS_ACCESS_URL}/{AWS_STORAGE_BUCKET_NAME}/media/"
...
STATIC_URL = (
    f"{AWS_S3_URL_PROTOCOL}://{AWS_ACCESS_URL}/{AWS_STORAGE_BUCKET_NAME}/static/"
)
